...
const STRINGS: Record<string, { ru: string; en: string }> = {
  ...
  commentsFindSub: { ru: 'Но вы можете найти этот трек на SoundCloud и использовать его комментарии для просмотра.', en: 'But you can find this track on SoundCloud and borrow its comments here.' },
  commentsSearching: { ru: 'Ищем на SoundCloud…', en: 'Searching SoundCloud…' },
  commentsNoMatches: { ru: 'На SoundCloud ничего не нашлось для этого трека.', en: 'Nothing found on SoundCloud for this track.' },
  commentsResetLink: { ru: 'Сбросить привязку', en: 'Reset link' },
