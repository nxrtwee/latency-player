...
// SoundCloud brand mark, redrawn as a flat single-color inline SVG (the official
// cloud-and-waveform silhouette). Replaces the full-color PNG app-icon, which read
// as a "sticker" over avatars. Defaults to currentColor so it blends into each
// context; pass `color` to force a tone (badges over artists use a neutral white).
