...
|-----------|--------|------|-----------|
| **Windows** | 0.3.3 | `Latency-0.3.3-x64.exe` (установщик) или `-portable.exe` | запустить установщик |
...
> 🖥️ **Активная разработка идёт на десктопе (Windows).** Текущая версия — **0.3.3**.
