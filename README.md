...
|-----------|--------|------|-----------|
| **Windows** | 0.4.1 | `Latency-0.4.1-x64.exe` (установщик) или `-portable.exe` | запустить установщик |
...
> 🖥️ **Активная разработка идёт на десктопе (Windows).** Текущая версия — **0.4.1**.
