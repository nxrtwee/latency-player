...
|-----------|--------|------|-----------|
| **Windows** | 0.4.0 | `Latency-0.4.0-x64.exe` (установщик) или `-portable.exe` | запустить установщик |
...
> 🖥️ **Активная разработка идёт на десктопе (Windows).** Текущая версия — **0.4.0**.
